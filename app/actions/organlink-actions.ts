...
export async function createDonorAction(rawData: unknown) {
  try {
    ...
    const message = err instanceof Error ? err.message : "Failed to register donor record.";
...
export async function reviewDonorApprovalAction(rawData: unknown) {
  try {
    ...
    const message = err instanceof Error ? err.message : "Failed to update donor approval status.";
    return { success: false, error: message };
  }
}
...
export async function createRecipientAction(rawData: unknown) {
  try {
    ...
    const message = err instanceof Error ? err.message : "Failed to register recipient record.";
    return { success: false, error: message };
  }
}
...
export async function registerOrganAction(rawData: unknown) {
  try {
    ...
    const message = err instanceof Error ? err.message : "Failed to register organ.";
    return { success: false, error: message };
  }
}
...
export async function updateOrganStatusAction(rawData: unknown) {
  try {
    ...
    const message = err instanceof Error ? err.message : "Failed to update organ availability status.";
    return { success: false, error: message };
  }
}
